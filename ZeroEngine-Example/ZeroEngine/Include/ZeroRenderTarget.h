...
public:
	...
	void SetRect(T _left, U _top, V _right, W _bottom) {
		rect.left = static_cast<LONG>(_left); rect.top = static_cast<LONG>(_top); rect.right = static_cast<LONG>(_right); rect.bottom = static_cast<LONG>(_bottom);
	}
