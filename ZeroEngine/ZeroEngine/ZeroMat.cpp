...
void ZeroMat::MatrixMultiply(Matrix & _matrix) {
	...
	//첫째 줄
	mat_temp._11 = (matrix._11*_matrix._11) + (matrix._12*_matrix._21) + (matrix._13*_matrix._31);
	mat_temp._12 = (matrix._11*_matrix._12) + (matrix._12*_matrix._22) + (matrix._13*_matrix._32);
	mat_temp._13 = (matrix._11*_matrix._13) + (matrix._12*_matrix._23) + (matrix._13*_matrix._33);

	//둘째 줄
	mat_temp._21 = (matrix._21*_matrix._11) + (matrix._22*_matrix._21) + (matrix._23*_matrix._31);
	mat_temp._22 = (matrix._21*_matrix._12) + (matrix._22*_matrix._22) + (matrix._23*_matrix._32);
	mat_temp._23 = (matrix._21*_matrix._13) + (matrix._22*_matrix._23) + (matrix._23*_matrix._33);

	//셋째 줄
	mat_temp._31 = (matrix._31*_matrix._11) + (matrix._32*_matrix._21) + (matrix._33*_matrix._31);
	mat_temp._32 = (matrix._31*_matrix._12) + (matrix._32*_matrix._22) + (matrix._33*_matrix._32);
	mat_temp._33 = (matrix._31*_matrix._13) + (matrix._32*_matrix._23) + (matrix._33*_matrix._33);
...
void ZeroMat::Translate(float _x, float _y) {
	...
	mat._31 = _x; mat._32 = _y; mat._33 = 1;
